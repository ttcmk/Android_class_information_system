...
import com.example.popupmenutest.FreeclassroomModel;
...
public class SQLfreeclassroom {
	...
	private static final String DATABASE_NAME = "dbclassroom";
	...
	public SQLfreeclassroom(Context ctx) {
		this.mCtx = ctx;
	...
	public boolean create(FreeclassroomModel roomModel) {
	...
	public boolean update(FreeclassroomModel roomModel) {
//		Log.i(MainActivity.ACTIVITY_SERVICE,"1!!!!!!!!!!!!!!!!!!!!!!!"+queryboolean(roomModel.getId()));
		ContentValues values = new ContentValues();
		values.put(ID, roomModel.getId());
		if (roomModel.getNum() !="")
			values.put(NUM, roomModel.getNum());
	...
	public FreeclassroomModel getRoomById(String id) {
		FreeclassroomModel temp = new FreeclassroomModel();
